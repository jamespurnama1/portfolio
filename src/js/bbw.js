...
.to ("#text_5", 0.5, {opacity: 0})
  ...
  scenes.push(new ScrollMagic.Scene({
    triggerElement: "#bbw__image--1",
    duration: "50%"
  })
  .setTween(tween1)
  .setClassToggle("#bbw__image--1", "enlarge")
  // .addIndicators() //DEBUGGING!
  .addTo(controller)
  );

  scenes.push(new ScrollMagic.Scene({
    triggerElement: "#bbw__image--2",
    duration: "50%"
  })
  .setTween(tween2)
  .setClassToggle("#bbw__image--2", "enlarge")
  // .addIndicators() //DEBUGGING!
  .addTo(controller)
  );

  scenes.push(new ScrollMagic.Scene({
    triggerElement: "#bbw__image--3",
    duration: "50%"
  })
  .setTween(tween3)
  .setClassToggle("#bbw__image--3", "enlarge")
  // .addIndicators() //DEBUGGING!
  .addTo(controller)
  );

  scenes.push(new ScrollMagic.Scene({
    triggerElement: "#bbw__image--4",
    duration: "50%"
  })
  .setTween(tween4)
  .setClassToggle("#bbw__image--4", "enlarge")
  // .addIndicators() //DEBUGGING!
  .addTo(controller)
  );
  
  scenes.push(new ScrollMagic.Scene({
    triggerElement: "#bbw__image--5",
    duration: "50%"
  })
  .setTween(tween5)
  .setClassToggle("#bbw__image--5", "enlarge")
  // .addIndicators() //DEBUGGING!
  .addTo(controller)
  );
